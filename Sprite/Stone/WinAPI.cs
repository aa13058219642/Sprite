...
namespace StoneLib
{
    class WinAPI
    {
        ...
        public static void SelectBitmap(Form form, Bitmap bitmap, Color transparentColor, int opacity = 255)
        {
            bitmap.MakeTransparent(transparentColor);
            SelectBitmap(form, bitmap, opacity);
        }



        public static void SelectBitmap(Form form, Bitmap bitmap, Bitmap alphaBitmap)
        {
            Bitmap bmp = getGrayOverlay(bitmap, alphaBitmap);


            SelectBitmap(form, bmp, 255);
        }
        ...
        /// </param>
        public static void SelectBitmap(Form form, Bitmap bitmap, int opacity=255)
        {
            ...
            try
            {
                ...
                CSize newSize = new CSize(bitmap.Width, bitmap.Height);
        ...
        #region WINAPI Methods and Structures
        ...
        public struct CSize
        {
            ...
            public CSize(Int32 cx, Int32 cy)
        ...
        static extern bool UpdateLayeredWindow(IntPtr hwnd, IntPtr hdcDst,
            ref Point pptDst, ref CSize psize, IntPtr hdcSrc, ref Point pprSrc,
